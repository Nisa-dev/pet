...
class ServiceController extends Controller
{
    ...
    {
        $dog_installs = InstallMicrochip::where('user_id',Auth::user()->id)->latest()->paginate(10);
    ...
    public function store_request_change_owner (Request $request) {
        ...
        return redirect()->back()->with('success','แจ้งขอเปลี่ยนข้อมูลแล้ว');
    }
    ...
    public function admin_change_owner(Request $request) 
    {
        $request_change = new RequestChangeOwner([
            'install_microchip_breed' => $request->install_microchip_breed,
            'install_microchip_color' => $request->install_microchip_color,
        ...
        return redirect()->back()->with('success','เปลี่ยนข้อมูลเจ้าของแล้ว');
    }
